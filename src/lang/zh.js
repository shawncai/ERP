export default {
  ...
  prompt: {
    ...
    gdjwfq: '该单据为分期',
    gdjwxj: '该单据为现金',
    ckslgykcsl: '出库数量超出了当前仓库可用存量，请输入正确出库数量!',
    ckslcgpcsl: '出库数量超出了当前批次可用存量，请输入正确出库数量!',
    wlyxslbwfq: '无来源时销售类别不能是分期',
    dcckytbm: '电池出库时相关编码必填',
    zcckytbm: '整车出库时相关编码必填',
    pchwbnwk: '批次货位不能为空',
    sfqrhwyck: '是否确认货物已经出库',
    qrcg: '确认成功',
    fqsq: '分期申请',
    wpytj: '物品已添加',
    qxzdj: '请选择单据',
