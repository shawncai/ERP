...
// 极速采购订单列表
export function stockorderGetList(query) {
  var params = new URLSearchParams()
  ...
  if (query.arrivalFlag !== '' && query.arrivalFlag !== null && query.arrivalFlag !== undefined) {
    params.append('arrivalFlag', query.arrivalFlag) // 你要传给后台的参数值 key/value
  }
  params.append('pageNum', query.pageNum) // 你要传给后台的参数值 key/value
  params.append('pageSize', query.pageSize) // 你要传给后台的参数值 key/value
  return request({
    url: '/stockorder/getList',
    method: 'post',
    data: params
  })
}
...
export function stockorderlist(query) {
  ...
  if (query.orderId !== '' && query.orderId !== null && query.orderId !== undefined) {
    params.append('orderId', query.orderId) // 你要传给后台的参数值 key/value
  }
  if (query.title !== '' && query.title !== null && query.title !== undefined) {
    params.append('title', query.title) // 你要传给后台的参数值 key/value
  }
