...
// 生产需求列表
export function producerequirelist(query) {
  var params = new URLSearchParams()
  if (query.requireId !== '' && query.requireId !== null && query.requireId !== undefined) {
    params.append('requireId', query.requireId) // 你要传给后台的参数值 key/value
  }
