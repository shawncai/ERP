...
export function addStockInvoice(query, query2, query3) {
  ...
  return request({
    url: '/stockInvoice/addStockInvoice',
    method: 'post',
    data: params
  })
}
...
export function stockInvoiceList(query) {
  ...
  if (query.id !== '' && query.id !== null && query.id !== undefined) {
    params.append('invoiceId', query.id) // 你要传给后台的参数值 key/value
  }
  ...
  return request({
    url: '/stockInvoice/stockInvoiceList',
    method: 'post',
    data: params
  })
}
...
// 极速查询采购退货
export function stockInvoiceGetList(query) {
  var params = new URLSearchParams()
  if (query.invoiceId !== '' && query.invoiceId !== null && query.invoiceId !== undefined) {
    params.append('invoiceId', query.invoiceId) // 你要传给后台的参数值 key/value
  }
...
export function deletestockinvoice(query, query2) {
  ...
  return request({
    url: '/stockInvoice/deletestockinvoice',
    method: 'post',
    data: params
  })
}
...
export function updatestockinvoice(query, query2, query3) {
  ...
  params.append('stockInvoiceDetailJson', query2) // 你要传给后台的参数值 key/value
  return request({
    url: '/stockInvoice/updatestockinvoice',
    method: 'post',
    data: params
  })
}
