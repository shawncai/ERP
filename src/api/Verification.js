...
export function verificationList(query) {
  ...
  if (query.verificationId !== '' && query.verificationId !== null && query.verificationId !== undefined) {
    params.append('verificationId', query.verificationId) // 你要传给后台的参数值 key/value
  }
...
// 极速查询转账单
export function verificationGetList(query) {
  var params = new URLSearchParams()
  if (query.title !== '' && query.title !== null && query.title !== undefined) {
    params.append('title', query.title) // 你要传给后台的参数值 key/value
  }
