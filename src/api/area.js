...
export function regionmanagercandidate(regionid) {
  ...
  return request({
    url: '/pss/region/regionmanagercandidate',
    method: 'post',
    data: params
  })
}
...
export function getregionbylevel(level) {
  ...
  return request({
    url: '/pss/region/getregionbylevel',
    method: 'post',
    data: params
  })
}
