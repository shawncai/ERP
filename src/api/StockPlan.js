...
export function stockplanlist(query) {
  ...
  if (query.planId !== '' && query.planId !== null && query.planId !== undefined) {
    params.append('planId', query.planId) // 你要传给后台的参数值 key/value
  }
...
// 删除采购计划
export function deletestockplan(query, query2) {
  var params = new URLSearchParams()
