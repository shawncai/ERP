...
export function addproduceplan(query, query2, query3) {
  ...
  return request({
    url: '/produceplan/addproduceplan',
    method: 'post',
    data: params
  })
}
...
export function produceplanlist(query) {
  ...
  if (query.id !== '' && query.id !== null && query.id !== undefined) {
    params.append('planId', query.id) // 你要传给后台的参数值 key/value
  }
  ...
  return request({
    url: '/produceplan/produceplanlist',
    method: 'post',
    data: params
  })
}
...
// 极速生产任务单列表
export function produceplangetList(query) {
  var params = new URLSearchParams()
  if (query.title !== '' && query.title !== null && query.title !== undefined) {
    params.append('title', query.title) // 你要传给后台的参数值 key/value
  }
...
export function deleteproduceplan(query, query2) {
  ...
  return request({
    url: '/produceplan/deleteproduceplan',
    method: 'post',
    data: params
  })
}
...
export function updateproduceplan(query, query2) {
  ...
  return request({
    url: '/produceplan/updateproduceplan',
    method: 'post',
    data: params
  })
}
