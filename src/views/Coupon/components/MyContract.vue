        ...
        <el-form ref="getemplist" :model="getemplist" style="margin-top: -9px">
          ...
          <el-col :span="3" style="margin-left: 30px">
            <el-popover
              ...
              <el-input v-model="customerName" :placeholder="$t('SaleContract.customerName')" style="width: 40%;float: right;margin-right: 20px;" clearable @focus="chooseCustomer" @clear="restFilter"/>
