    ...
    <el-card class="box-card" style="margin-top: 15px" shadow="never">
      ...
      <div class="container">
        <el-editable
          ...
          <el-editable-column prop="quantity" align="center" :label="$t('updates.cksli')" min-width="150px"/>
          ...
          <el-editable-column prop="taxPrice" align="center" :label="$t('updates.ckj')" min-width="150px"/>
          <el-editable-column prop="taxRate" align="center" :label="$t('updates.slv')" min-width="150px"/>
          ...
          <el-editable-column prop="includeTaxCostMoney" align="center" :label="$t('updates.ckje')" min-width="150px"/>
          <el-editable-column prop="discount" align="center" :label="$t('updates.cklv')" min-width="150px"/>
