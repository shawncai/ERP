  ...
  <div class="ERP-container">
    ...
    <el-card class="box-card" style="margin-top: 10px" shadow="never">
      ...
      <el-table
        ...
        <el-table-column :label="$t('ReturnExchange.title')" :resizable="false" align="center" min-width="150">
          <template slot-scope="scope">
  ...
  methods: {
    ...
    handleCommand(command) {
      ...
      if (command === 'delete') {
        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
          ...
          deleteReturnExchange(ids).then(res => {
    ...
    handleDelete(row) {
      this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
        ...
        deleteReturnExchange(row.id).then(res => {
          if (res.data.ret === 200) {
            this.$notify({
              title: '删除成功',
              type: 'success',
