            ...
            <el-row>
              ...
              <el-col :span="6">
                <el-form-item :label="$t('income.incomeRepositoryId')" style="width: 100%;">
                  <el-input v-model="incomeRepositoryId" style="margin-left: 18px;width: 218px" @focus="handlechooseRep"/>
              ...
              <el-col :span="6">
                <el-form-item :label="$t('income.incomeAccount')" style="width: 100%;">
                  <el-input v-model="personalForm.incomeAccount" style="margin-left: 18px;width: 218px" clearable/>
                </el-form-item>
              </el-col>
              <el-col :span="6">
...
export default {
  ...
  methods: {
    ...
    getdatatime() { // 默认显示今天
      this.personalForm.incomeDate = new Date()
    },
    // 门店focus事件触发
    handlechooseRep() {
