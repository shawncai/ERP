<template>
  <div class="ERP-container">
    <el-card class="box-card" style="margin-top: 10px" shadow="never">
      ...
      <el-input v-model="getemplist.title" :placeholder="$t('CheckFail.title')" class="filter-item" clearable @keyup.enter.native="handleFilter"/>

      <el-input v-model="getemplist.handleNumber" :placeholder="$t('updates.djbh')" class="filter-item" clearable @keyup.enter.native="handleFilter"/>

      <el-input v-model="handlePersonId" :placeholder="$t('CheckFail.handlePersonId')" class="filter-item" clearable @keyup.enter.native="handleFilter" @focus="handlechooseStock" @clea="restFilter"/>
...
<script>
import { checkfaillist, deletecheckfail, updatecheckfail2 } from '@/api/CheckFail'
...
export default {
  ...
  methods: {
    ...
    getlist() {
      ...
      checkfaillist(this.getemplist).then(res => {
        if (res.data.ret === 200) {
