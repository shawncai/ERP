<template>
  <el-dialog :visible.sync="editVisible" :detailcontrol="detailcontrol" :detaildata="detaildata" :close-on-press-escape="false" append-to-body class="edit" top="10px" title="修改采购报溢单" @close="$emit('update:detailcontrol', false)">
    <div id="printTest" >
      <!--基本信息-->
      <el-card class="box-card">
        ...
        <div class="container">
          <el-form ref="personalForm" :model="personalForm" :rules="personalrules" :inline="true" status-icon class="demo-ruleForm" label-width="100px" style="margin-left: 30px;">
            <el-row>
              <el-col :span="12">
                <el-form-item class="print2" label="报溢单编号" style="width: 100%;display: none">
                  {{ personalForm.overflowNumber }}
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item :label="$t('InventoryOverflow.title')" style="width: 100%;">
                  <el-input v-model="personalForm.title" placeholder="请输入报溢单主题" style="margin-left: 18px;width: 150px" disabled/>
                </el-form-item>
              </el-col>
              <el-col :span="6">
              ...
              <el-col :span="6">
                <el-form-item :label="$t('InventoryOverflow.overflowRepositoryId')" prop="overflowRepositoryId" style="width: 100%;">
                  <el-input v-model="overflowRepositoryId" placeholder="请选择报溢仓库" style="margin-left: 18px;width: 150px" disabled @focus="handlechooseRep"/>
                </el-form-item>
