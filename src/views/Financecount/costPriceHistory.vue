<template>
  <div class="ERP-container">
    <el-card :body-style="	{ padding: '5px' }" class="box-card" style="margin-top: 5px" shadow="never">
      ...
      <el-input v-model="getemplist.productCode" :placeholder="$t('saleBillList.productCode')" class="filter-item" clearable @keyup.enter.native="handleFilter"/>
      <el-date-picker
        v-model="date"
    ...
    <el-card :body-style="	{ padding: '10px' }" class="box-card" shadow="never">
      ...
      <el-table
        ...
        <el-table-column
          ...
          align="center"/>
        <el-table-column
          :label="$t('collectAndPayDetail.cbj')"
          prop="costPrice"
          sortable
          align="center"/>
        <el-table-column
          :label="$t('update4.tiaozhengriqi')"
          prop="adjustDate"
          sortable
          align="center"/>
      </el-table>
...
<script>
import { getCostPriceHistory } from '@/api/count'
...
export default {
  ...
  methods: {
    ...
    handleFilter() {
      ...
      getCostPriceHistory(this.getemplist).then(res => {
        if (res.data.ret === 200) {
