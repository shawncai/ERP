  ...
  <div class="ERP-container">
    <div class="app-container" style="padding-right: 0">
      ...
      <el-card :body-style="	{ padding: '5px' }" class="box-card" shadow="never">
        ...
        <div class="container" style="margin-top: 25px">
          <el-form ref="personalForm" :model="personalForm" :rules="personalrules" :inline="true" size="mini" status-icon class="demo-ruleForm" label-position="left" label-width="130px">
            <el-row>
              <el-col :span="6">
                <el-form-item :label="$t('BuildUp.title')" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-input v-model="personalForm.title" placeholder="请输入组装单主题" style="width: 200px" clearable/>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item :label="$t('SaleOut.sourceType')" prop="sourceType" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-select v-model="personalForm.sourceType" style="width: 200px" @change="clearinput">
              ...
              <el-col :span="6" >
                <el-form-item :label="$t('StockArrival.sourceNumber')" style="margin-left: 18px;width: 100%;margin-bottom: 0">
              ...
              <el-col :span="6">
                <el-form-item :label="$t('BuildUp.handlePersonId')" prop="handlePersonId" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-input v-model="handlePersonId" placeholder="请选择经办人" style="width: 200px" clearable @focus="handlechoose"/>
                </el-form-item>
                <my-create :createcontrol.sync="createcontrol" @createname="createname"/>
              </el-col>
              <el-col :span="6">
                <el-form-item :label="$t('BuildUp.buildupDeptId')" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-select v-model="personalForm.buildupDeptId" placeholder="请选择组装部门" style="width: 200px" clearable >
                    <el-option
              ...
              <el-col :span="6">
                <el-form-item :label="$t('BuildUp.buildupRepositoryId')" prop="buildupRepositoryId" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-input v-model="buildupRepositoryId" placeholder="请选择仓库" style="width: 200px" clearable @focus="handlechooseRep"/>
                </el-form-item>
              ...
              <el-col :span="6">
                <el-form-item :label="$t('updates.hwygdj')" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-select v-model="personalForm.type" :placeholder="$t('updates.qxz')" style="width: 200px" >
      ...
      <el-card :body-style="	{ padding: '5px' }" class="box-card" shadow="never" style="margin-top: 5px">
        ...
        <div ref="fuzhu" class="form-name">{{ $t('updates.dzzdspmx') }}</div>
        <div class="container" style="margin-top: 25px">
          <el-editable
            ref="editable"
            :data.sync="list2"
      ...
      <el-card :body-style="	{ padding: '5px' }" class="box-card" shadow="never" style="margin-top: 5px; marign-bottom: 40px">
        ...
        <div class="container">
          <el-editable
            ...
            <!--            <el-editable-column :edit-render="{type: 'visible'}" :label="$t('Hmodule.hw')" prop="locationId" align="center" min-width="170px">-->
            <!--              <template slot="edit" slot-scope="scope">-->
            <!--                <el-select v-model="scope.row.locationCode" :value="scope.row.locationCode" :placeholder="$t('Hmodule.xzhw')" filterable clearable style="margin-left: 18px;width: 100%;margin-bottom: 0" @visible-change="updatebatch4($event,scope)">-->
            <!--                  <el-option-->
            <!--                    v-for="(item, index) in locationlist"-->
            <!--                    :key="index"-->
            <!--                    :value="item.locationCode"-->
...
export default {
  ...
  methods: {
    ...
    handlecancel() {
      this.$router.go(-1)
      const view = { path: '/BuildUp/BuildUpList', name: 'BuildUpList', fullPath: '/BuildUp/BuildUpList', title: 'BuildUpList' }
