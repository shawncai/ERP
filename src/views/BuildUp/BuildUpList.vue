  ...
  <div class="ERP-container">
    ...
    <el-card class="box-card" style="margin-top: 15px;height: 60px">
      <el-row>
        <el-form ref="getemplist" :model="getemplist" label-width="100px" style="margin-top: -9px">
          ...
          <el-col :span="4">
            <el-form-item label="组装部门">
              <el-select v-model="getemplist.buildupDeptId" placeholder="请选择组装部门" style="margin-left: 18px;width: 144px" clearable >
                <el-option
    ...
    <el-card class="box-card" style="margin-top: 15px">
      ...
      <el-table
        ...
        <el-table-column :label="$t('BuildUp.judgeStat')" :resizable="false" align="center" min-width="150">
          <template slot-scope="scope">
...
import { buildlist, deletebuildup } from '@/api/BuildUp'
