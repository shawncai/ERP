<template>
  <el-dialog :visible.sync="productVisible" :buildcontrol="buildcontrol" :close-on-press-escape="false" top="10px" title="选择商品" append-to-body @close="$emit('update:buildcontrol', false)">
