    ...
    <el-card class="box-card" style="margin-top: 15px;margin-bottom: 35px" shadow="never">
      ...
      <div class="container">
        <el-editable
          ...
          <el-editable-column :edit-render="{name: 'ElSelect', options: invoiceTypes, type: 'visible'}" prop="invoiceType" align="center" :label="$t('updates.fplx')" min-width="170px"/>
          <el-editable-column :edit-render="{name: 'ElInputNumber', attrs: {min: 0}, type: 'visible'}" prop="payThis" align="center" :label="$t('updates.bczfje')" min-width="170px"/>
          <el-editable-column :edit-render="{name: 'ElInputNumber', attrs: {min: 0}, type: 'visible'}" prop="advanceMoney" align="center" :label="$t('updates.dkyfk')" min-width="170px"/>
        </el-editable>
      </div>
    </el-card>
