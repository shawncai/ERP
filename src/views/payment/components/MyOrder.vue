      ...
      <el-row>
        <el-form ref="getemplist" :model="getemplist" style="margin-top: -9px">
          ...
          <el-col :span="3" style="margin-left: 20px">
            <el-form-item>
              <el-input v-model="stockPersonId" :placeholder="$t('StockOrder.stockPersonId')" clearable @keyup.enter.native="handleFilter" @clear="restFilter2" @focus="handlechooseStock"/>
            </el-form-item>
