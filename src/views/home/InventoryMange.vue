...
<script>
  ...
  import { SaleMange1, SaleMange2, SaleMange3,inventoryMange,inventoryMange2,inventoryMange3,inventoryMange5 } from '@/api/home'
      ...
      getlist() {
        ...
        inventoryMange3(this.getemplist2).then(res => {
          if (res.data.ret === 200) {
            ...
            let arr1 = new Array(res.data.data.content)
            console.log(arr1)
