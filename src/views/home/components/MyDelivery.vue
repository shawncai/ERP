<template>
  <el-dialog :visible.sync="employeeVisible" :deliverycontrol="deliverycontrol" :close-on-press-escape="false" top="10px" :title="$t('Hmodule.xzyg')" append-to-body @close="$emit('update:deliverycontrol', false)">
