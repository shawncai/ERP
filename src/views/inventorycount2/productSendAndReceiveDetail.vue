    ...
    <el-card :body-style="	{ padding: '10px' }" class="box-card" shadow="never">
      ...
      <el-table
        ...
        <el-table-column
          ...
          align="center"/>
        <el-table-column
          :label="$t('update4.receiveQuantity')"
          prop="receiveQuantity"
          width="200"
          align="center"/>
        <el-table-column
          :label="$t('update4.sendQuantity')"
          prop="sendQuantity"
          width="200"
          align="center"/>
        <el-table-column
          :label="$t('update4.endQuantity')"
          prop="endQuantity"
          width="200"
          align="center"/>
      </el-table>
...
import { productSendAndReceiveDetail } from '@/api/count'
...
export default {
  ...
  methods: {
    ...
    getlist() {
      ...
      productSendAndReceiveDetail(this.getemplist).then(res => {
        if (res.data.ret === 200) {
    ...
    handleFilter() {
      ...
      if (this.date === null || this.date === undefined || this.date === '' || this.date === [] || this.date.length === 0) {
