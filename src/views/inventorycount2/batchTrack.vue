<template>
  <div class="ERP-container">
    <el-card :body-style="	{ padding: '5px' }" class="box-card" style="margin-top: 5px" shadow="never">
      ...
      <el-input v-model="getemplist.accessNumber" :placeholder="$t('update4.accessNumber')" size="small" class="filter-item" clearable @keyup.enter.native="handleFilter"/>
    ...
    <el-card :body-style="	{ padding: '10px' }" class="box-card" shadow="never">
      ...
      <el-table
        ...
        <el-table-column
          ...
          align="center"/>
        <el-table-column
          :label="$t('update4.productType')"
          prop="productType"
          width="200"
          align="center"/>
        <el-table-column
          :label="$t('update4.unit')"
          prop="unit"
          width="200"
          align="center"/>
        <el-table-column
          :label="$t('update4.accessQuantity')"
          prop="accessQuantity"
          width="200"
          align="center"/>
      </el-table>
...
import { batchTrack } from '@/api/count'
...
export default {
  ...
  methods: {
    ...
    getlist() {
      ...
      batchTrack(this.getemplist).then(res => {
        if (res.data.ret === 200) {
