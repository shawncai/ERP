    ...
    <el-card class="box-card" style="margin-top: 10px" shadow="never">
      ...
      <el-table
        ...
        <el-table-column
          ...
          align="center"/>
        <el-table-column
          :label="$t('inventoryFluid.recieptType')"
          prop="recieptType"
          width="200"
          align="center"/>
        <el-table-column
          :label="$t('inventoryFluid.repositoryId')"
          prop="repositoryId"
          width="200"
          align="center"/>
        <el-table-column
          :label="$t('inventoryFluid.repositoryName')"
          prop="repositoryName"
          width="200"
          align="center"/>
        <el-table-column
          :label="$t('inventoryFluid.batch')"
          prop="batch"
          width="200"
          align="center"/>
        <el-table-column
          ...
          align="center"/>
        <el-table-column
          :label="$t('inventoryFluid.locationCode')"
          prop="locationCode"
          width="200"
          align="center"/>
        <el-table-column
        ...
        <el-table-column
          ...
          align="center"/>
        <el-table-column
          :label="$t('inventoryFluid.time')"
          prop="time"
          width="200"
          align="center"/>
        <el-table-column
          :label="$t('inventoryFluid.quantity')"
          prop="quantity"
          width="200"
          align="center"/>
        <el-table-column
          :label="$t('inventoryFluid.endQuantity')"
          prop="endQuantity"
          width="200"
          align="center"/>
        <el-table-column
          :label="$t('inventoryFluid.createPersonName')"
...
import { inventoryFluid } from '@/api/count'
...
export default {
  ...
  methods: {
    ...
    getlist() {
      ...
      this.categorys = []
      const param = {}
      param.categoryName = '采购退货单'
      param.id = 14
      this.categorys.push(param)
      const param2 = {}
      param2.categoryName = '销售出库单'
      param2.id = 28
      this.categorys.push(param2)
      ...
      inventoryFluid(this.getemplist).then(res => {
        if (res.data.ret === 200) {
