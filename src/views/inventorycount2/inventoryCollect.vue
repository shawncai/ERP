<template>
  <div class="ERP-container">
    <el-card :body-style="	{ padding: '5px' }" class="box-card" style="margin-top: 5px" shadow="never">
      ...
      <el-input v-model="getemplist.brand" :placeholder="$t('updates.pp')" size="small" class="filter-item" clearable @keyup.enter.native="handleFilter"/>
    ...
    <el-card :body-style="	{ padding: '10px' }" class="box-card" shadow="never">
      ...
      <el-table
        ...
        <el-table-column
          ...
          align="center"/>
        <el-table-column
          :label="$t('inventoryCollect.allQuantity')"
          prop="allQuantity"
          width="200"
          align="center"/>
        <el-table-column
          :label="$t('inventoryCollect.actualCostPrice')"
          prop="actualCostPrice"
          width="200"
          align="center"/>
        <el-table-column
          :label="$t('inventoryCollect.actualMoney')"
          prop="actualMoney"
          width="200"
          align="center"/>
        <el-table-column
          :label="$t('inventoryCollect.saleMoney')"
          prop="saleMoney"
          width="200"
          align="center"/>
        <el-table-column
          :label="$t('inventoryCollect.tradeMOney')"
          prop="tradeMOney"
          width="200"
          align="center"/>
        <el-table-column
          :label="$t('inventoryCollect.rate')"
          prop="rate"
          width="200"
          align="center"/>
      </el-table>
...
import { inventoryCollect } from '@/api/count'
...
export default {
  ...
  methods: {
    ...
    getlist() {
      ...
      inventoryCollect(this.getemplist).then(res => {
        if (res.data.ret === 200) {
