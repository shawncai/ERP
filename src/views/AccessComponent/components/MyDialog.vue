    ...
    <el-card class="box-card" style="margin-top: 15px;margin-bottom: 20px" shadow="never">
      ...
      <div class="container">
        <el-editable
          ...
          <el-editable-column :edit-render="{name: 'ElInputNumber', attrs: {min: 1.00, precision: 6}, type: 'visible'}" :label="$t('accessComponent.accessQuantity')" prop="outQuantity" align="center" min-width="150">
            <template slot="edit" slot-scope="scope">
              <el-input-number
                :precision="6"
                :controls="true"
