<template>
  <div class="ERP-container">
    <el-card :body-style="	{ padding: '5px' }" class="box-card" style="margin-top: 5px" shadow="never">
      ...
      <el-select v-model="getemplist.sendType" :placeholder="$t('SaleOrder.sendType')" :value="getemplist.sendType" size="small" class="filter-item" clearable @keyup.enter.native="handleFilter">
      ...
      <el-popover
        ...
        size="small"
        trigger="click">
        <el-select v-model="getemplist.customerType" :placeholder="$t('SaleOrder.customerType')" size="small" clearable style="width: 40%;float: left;margin-left: 20px">
