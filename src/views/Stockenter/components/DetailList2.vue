      ...
      <el-card class="box-card">
        ...
        <div class="container">
          <el-form ref="personalForm" :model="personalForm" :rules="personalrules" :inline="true" status-icon class="demo-ruleForm" label-width="100px" style="margin-left: 30px;">
            <el-row>
              <el-col :span="12">
                <el-form-item class="print2" label="生产入库单编号" style="width: 100%;display: none">
              ...
              <el-col :span="6">
                <el-form-item :label="$t('Stockenter.processType')" prop="processType" style="width: 100%;">
                  <el-select v-model="personalForm.processType" placeholder="请选择加工类别" style="margin-left: 18px;width: 150px" disabled >
              ...
              <el-col :span="6">
                <el-form-item :label="$t('Stockenter.produceManagerId')" style="width: 100%;">
                  <el-input v-model="produceManagerId" placeholder="请选择生产负责人" style="margin-left: 18px;width: 150px" disabled @focus="handlechoose"/>
                </el-form-item>
      ...
      <el-card class="box-card" style="margin-top: 15px">
        ...
        <div class="container">
          <el-editable
            ...
            <el-editable-column :edit-render="{name: 'ElInputNumber'}" prop="enterQuantity" align="center" :label="$t('updates.rksl')" />
