<template>
  <el-dialog :visible.sync="employeeVisible" :outcontrol="outcontrol" :close-on-press-escape="false" :title="$t('Hmodule.xzyg')" top="10px" append-to-body @close="$emit('update:outcontrol', false)">
