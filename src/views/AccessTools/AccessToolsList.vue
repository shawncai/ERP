<template>
  <div class="ERP-container">
    <el-card :body-style="	{ padding: '5px' }" class="box-card" style="margin-top: 5px" shadow="never">
      <el-input v-model="getemplist.title" :placeholder="$t('AccessTools.title')" size="small" class="filter-item" clearable @keyup.enter.native="handleFilter"/>
      <el-select v-model="getemplist.useType" :placeholder="$t('AccessTools.useType')" size="small" class="filter-item" clearable>
        <el-option value="1" label="维修" />
        <el-option value="2" label="其他" />
      </el-select>
      <el-select v-model="getemplist.emergencyLevel" :placeholder="$t('AccessTools.emergencyLevel')" size="small" class="filter-item" clearable>
    ...
    <el-card :body-style=" { padding: '6px'}" class="box-card" shadow="never">
      ...
      <!-- 新建操作 -->
      <el-button v-permission="['54-67-82-1']" v-waves size="small" class="filter-item2" icon="el-icon-plus" type="success" style="width: 86px" @click="handleAdd">{{ $t('public.add') }}</el-button>
    </el-card>
