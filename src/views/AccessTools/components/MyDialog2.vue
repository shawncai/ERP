<template>
  <el-dialog :visible.sync="editVisible2" :editcontrol="editcontrol" :editdata="editdata" :close-on-press-escape="false" :title="'修改'" width="1010px" class="edit" top="-10px" @close="$emit('update:editcontrol', false)">
    <!--子件信息-->
    <el-card class="box-card" style="margin-top: 15px" shadow="never">
      <h2 ref="fuzhu" class="form-name" >丢失明细</h2>
      <div class="container">
        <el-editable
          ref="editable"
          :data.sync="list2"
...
export default {
  ...
  watch: {
    editcontrol() {
      console.log(222)
      this.editVisible2 = this.editcontrol
      console.log(333)
    },
    editdata() {
      console.log(111)
