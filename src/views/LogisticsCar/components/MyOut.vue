<template>
  <el-dialog :visible.sync="employeeVisible" :outperson="outperson" :close-on-press-escape="false" top="10px" title="选择出车人" append-to-body @close="$emit('update:outperson', false)">
...
export default {
  ...
  data() {
    return {
      ...
      repositories: [],
      // 员工选择框控制
      employeeVisible: this.outperson,
      // 小区经理选择框控制
  ...
  watch: {
    outperson() {
      this.employeeVisible = this.outperson
    }
  },
  created() {
    this.gitemplist()
