      ...
      <el-card class="box-card" style="margin-top: 15px" shadow="never">
        ...
        <div class="container">
          <el-editable
            ...
            <el-editable-column prop="requireDate" align="center" :label="$t('updates.xqrq')" />
      ...
      <el-card class="box-card" style="margin-top: 15px" shadow="never">
        ...
        <div class="container">
          <el-editable
            ...
            <el-editable-column :label="$t('Hmodule.dw')" prop="unit" align="center"/>
            <el-editable-column prop="requireDate" align="center" :label="$t('updates.xqrq')"/>
            <el-editable-column prop="applyQuantity" align="center" :label="$t('updates.sqsl')"/>
            <el-editable-column prop="planQuantity" align="center" :label="$t('updates.yxdsl')"/>
            <el-editable-column prop="sourceSerialNumber" align="center" :label="$t('updates.ydxh')"/>
          </el-editable>
        </div>
      </el-card>
