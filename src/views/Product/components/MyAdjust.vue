<template>
  <el-dialog :visible.sync="editVisible" :control="control" :editdata="editdata" :close-on-press-escape="false" top="10px" :title="$t('updates.tjdxx')" @close="$emit('update:control', false)">
    <!--基本信息-->
