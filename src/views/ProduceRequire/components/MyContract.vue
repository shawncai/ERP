      ...
      <el-row>
        <el-form ref="getemplist" :model="getemplist" style="margin-top: -9px">
          ...
          <el-col :span="3" style="margin-left: 20px">
            <el-form-item>
              <el-input v-model="stockPersonId" :placeholder="$t('StockContract.stockPersonId')" clearable @clear="restFilter2" @keyup.enter.native="handleFilter" @focus="handlechooseStock"/>
            </el-form-item>
...
<script>
import { searchstockContract } from '@/api/StockContract'
...
export default {
  ...
  methods: {
    ...
    async handleConfirm() {
      ...
      const contractdata = this.choosedata.stockContractDetailVos
      const number = this.choosedata.contractNumber
      const contractDetail = contractdata.map(function(item) {
        return {
      ...
      this.$emit('contract', contractDetail)
      this.$emit('allcontractinfo', this.choosedata)
    }
    // 仓库管理员选择结束
  }
}
