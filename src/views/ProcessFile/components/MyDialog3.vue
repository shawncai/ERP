<template>
  <el-dialog :visible.sync="editVisible" :editcontrol="editcontrol" :editdata="editdata" :close-on-press-escape="false" class="edit" width="1010px" top="-10px" :title="$t('updates.xgbzgx')" @close="$emit('update:editcontrol', false)">
    <!--基本信息-->
    ...
    <el-card class="box-card" style="margin-top: 15px">
      ...
      <div class="container">
        <el-editable
          ...
          <el-editable-column prop="processFileName" align="center" :label="$t('updates.gymc')" min-width="150px"/>
        </el-editable>
      </div>
    </el-card>
