<template>
  <el-dialog :visible.sync="editVisible" :control="control" :editdata="editdata" :close-on-press-escape="false" width="1010px" top="10px" :title="$t('updates.xgspgz')" @close="$emit('update:control', false)">
    <!--基本信息-->
