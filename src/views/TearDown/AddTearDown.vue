            ...
            <el-row>
              <el-col :span="6">
                <el-form-item :label="$t('TearDown.title')" style="width: 100%;">
                  <el-input v-model="personalForm.title" placeholder="请输入拆装单主题" style="margin-left: 18px" clearable/>
                </el-form-item>
              </el-col>
              <el-col :span="6">
              ...
              <el-col :span="6">
                <el-form-item :label="$t('TearDown.teardownDeptId')" style="width: 100%;">
                  <el-select v-model="personalForm.teardownDeptId" placeholder="请选择拆装部门" style="margin-left: 18px;width: 218px" clearable >
                    <el-option
              ...
              <el-col :span="6">
                <el-form-item :label="$t('TearDown.teardownRepositoryId')" prop="teardownRepositoryId" style="width: 100%;">
                  <el-input v-model="teardownRepositoryId" placeholder="请选择仓库" style="margin-left: 18px" clearable @focus="handlechooseRep"/>
                </el-form-item>
...
export default {
  ...
  methods: {
    ...
    updatebatch(event, scope) {
      if (event === true) {
        console.log(this.personalForm.teardownRepositoryId)
        if (this.personalForm.teardownRepositoryId === undefined || this.personalForm.teardownRepositoryId === '') {
          this.$notify.error({
            title: '错误',
            message: '请先选择仓库',
            offset: 100
    ...
    handlecancel() {
      this.$router.go(-1)
      const view = { path: '/TearDown/AddTearDown', name: 'AddTearDown', fullPath: '/TearDown/AddTearDown', title: 'AddTearDown' }
