<template>
  <div class="ERP-container">
    <el-card :body-style="	{ padding: '5px' }" class="box-card" style="margin-top: 5px" shadow="never">
      <el-select v-model="getemplist.receiptType" :placeholder="$t('updates.stat')" :value="getemplist.type" size="small" class="filter-item" clearable @keyup.enter.native="handleFilter">
      ...
      <el-input v-model="repositoryId" :placeholder="$t('updates.repository')" size="small" class="filter-item" clearable @keyup.enter.native="handleFilter" @focus="handlechooseRep" @clear="restFilter2"/>
    ...
    <el-card :body-style="	{ padding: '10px' }" class="box-card" shadow="never">
      ...
      <el-table
        ...
        <el-table-column
          ...
          align="center"/>
        <el-table-column
          :label="$t('productStockFluid.receiptType')"
          prop="receiptType"
          width="200"
          align="center"/>
        <el-table-column
        ...
        <el-table-column
          ...
          align="center"/>
        <el-table-column
          :label="$t('productStockFluid.color')"
          prop="color"
          width="200"
          align="center"/>
        <el-table-column
          :label="$t('productStockFluid.batch')"
          prop="batch"
          width="200"
          align="center"/>
        <el-table-column
        ...
        <el-table-column
          ...
          align="center"/>
        <el-table-column
          :label="$t('productStockFluid.price')"
          prop="price"
          width="200"
          align="center"/>
        <el-table-column
          ...
          align="center"/>
        <el-table-column
          :label="$t('productStockFluid.categoryName')"
          prop="categoryName"
          width="200"
          align="center"/>
        <el-table-column
          :label="$t('productStockFluid.supplierName')"
          prop="supplierName"
          width="200"
          align="center"/>
        <el-table-column
...
import { productStockFluid } from '@/api/count'
...
export default {
  ...
  methods: {
    ...
    getlist() {
      ...
      productStockFluid(this.getemplist).then(res => {
        if (res.data.ret === 200) {
