          ...
          <el-form ref="personalForm" :model="personalForm" :rules="personalrules" :inline="true" size="mini" status-icon class="demo-ruleForm" label-position="left" label-width="130px">
            <el-row>
              ...
              <el-col :span="6">
                ...
                <my-customer :customercontrol.sync="installmentcontrol" @mypaydata="mypaydata" @Installment="Installment"/>
              </el-col>
              <el-col :span="6">
...
import { createreceipt } from '@/api/saleReceipt'
...
export default {
  ...
  computed: {
    myshouldMoney() {
      return this.personalForm.receiptMoney
    }
  },
  watch: {
    myshouldMoney: {
  ...
  methods: {
    ...
    updatePrice() {
      console.log('999', 999)
      if (this.personalForm.receiptMoney !== null && this.personalForm.receiptMoney !== '' && this.personalForm.receiptMoney !== undefined) {
        if (this.personalForm.customerPay !== null && this.personalForm.customerPay !== '' && this.personalForm.customerPay !== undefined) {
          console.log('this.personalForm.customerPay', this.personalForm.customerPay)
          console.log('this.personalForm.receiptMoney', this.personalForm.receiptMoney)
          // 客户给的钱多
          if (Number(this.personalForm.customerPay) > Number(this.personalForm.receiptMoney)) {
            this.personalForm.changeMoney = Number(this.personalForm.customerPay - this.personalForm.receiptMoney).toFixed(2)
          } else {
            this.personalForm.changeMoney = 0
          }
          console.log('this.personalForm.changeMoney', this.personalForm.changeMoney)
        }
      }
    },
    changeCoupon() {
    ...
    //     this.personalForm.totalLackMoney = sums[1]
