<template>
  <div class="ERP-container">
    ...
    >
      ...
      <el-input
        v-model="receiptRepositoryId"
        :placeholder="$t('updates.xsmd')"
        size="small"
        class="filter-item"
      ...
      />
      <my-repository
        :repositorycontrol.sync="repositorycontrol"
        @repositoryname="repositoryname"
      />
      <el-input
        v-model="getemplist.title"
        :placeholder="$t('updates.skdzt')"
        size="small"
        class="filter-item"
        clearable
        @keyup.enter.native="handleFilter"
      />
      <el-input
        v-model="getemplist.customerName"
        :placeholder="$t('updates2.customerName')"
        size="small"
        class="filter-item"
        clearable
        @keyup.enter.native="handleFilter"
    ...
    <el-card :body-style="{ padding: '6px' }" class="box-card" shadow="never">
      ...
      <el-dialog
        ...
        :title="$t('otherlanguage.newvoucher')"
        class="normal"
        width="600px"
        center
      >
        ...
        >
          <el-form-item
            :label="$t('otherlanguage.md')"
            label-width="100px"
            prop="type"
          >
            <el-select
              v-model="voucherparms.repositoryId"
              :disabled="isvoucherrep"
              style="width: 100%"
              filterable
              clearable
              @change="choosevoucherrep"
            >
              <el-option
        ...
        <span slot="footer" class="dialog-footer">
          <el-button type="primary" @click="handlevoucher()">{{
            $t("Hmodule.sure")
          }}</el-button>
          <el-button type="danger" @click="closetag()">{{
            $t("Hmodule.cancel")
          }}</el-button>
        </span>
      </el-dialog>
    ...
    <el-card :body-style="{ padding: '10px' }" class="box-card" shadow="never">
      ...
      >
        ...
        <el-table-column
          :label="$t('Receipt.totalLackMoney')"
          :resizable="false"
          prop="totalLackMoney"
          align="center"
          min-width="150"
        ...
        <el-table-column
          :label="$t('Receipt.receiptPersonId')"
          :resizable="false"
          align="center"
          min-width="150"
        >
        ...
        >
          <template slot-scope="scope">
            ...
            <el-button
              v-permission2="['54-396-2', scope.row.createPersonId]"
              v-show="
              ...
              <el-col v-for="(item, index) in picPaths" :key="index">
                <el-card :body-style="{ padding: '0px' }">
                  <el-popover placement="top" trigger="hover">
                    ...
                    <img
                      slot="reference"
                      :src="'http://192.168.1.26:9090/uploads/receipt/' + item"
                      width="500px"
                      class="image"
                      style="width: 100%"
                    >
...
export default {
  ...
  methods: {
    ...
    handlevoucher() {
      ...
      if (
        this.voucherparms.date === '' ||
        this.voucherparms.date === null ||
        this.voucherparms.date === undefined
      ) {
        this.$notify.error({
      ...
      if (
        this.voucherparms.repositoryId === '' &&
        this.voucherparms.regionId === ''
      ) {
        this.$notify.error({
    ...
    getlist() {
      ...
      salereceiptGetList(this.getemplist).then(res => {
        if (res.data.ret === 200) {
