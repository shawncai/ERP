      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane :label="$t('repair.all')" name="first">
          <el-table
            ...
            style="width: 100%;">
            <el-table-column :label="$t('repair.coding')" prop="code" align="center" min-width="100">
              <template slot-scope="scope">
                <span>{{ scope.row.code }}</span>
              </template>
            </el-table-column>cnpm install node-sass@latest
            <el-table-column :label="$t('repair.customername')" prop="personName" width="90px" align="center">
              <template slot-scope="scope">
            ...
            <el-table-column :label="$t('repair.Warrantytime')" prop="serviceExpectTime" min-width="100px" align="center">
              <template slot-scope="scope">
                <span>{{ scope.row.serviceExpectTime }}</span>
              </template>
            </el-table-column>
            <el-table-column :label="$t('repair.stat')" prop="stat" min-width="85px" align="center">
              <template slot-scope="scope">
                <span>{{ scope.row.stat | zhuang }}</span>
              </template>
            </el-table-column>
            <el-table-column v-permission="[5, 6]" :label="$t('table.actions')" align="center" min-width="335px">
              <template slot-scope="scope">
                <el-button v-permission="[5]" type="primary" size="mini" @click="handleDetail(scope.row)">{{ $t('table2.view') }}</el-button>
                <el-button v-permission="[93]" v-show="scope.row.stat == 1" type="danger" size="mini" @click="handleDelete(scope.row)">{{ $t('Complaint.delete') }}</el-button>
                <el-button v-permission="[94]" v-show="scope.row.stat == 1" size="mini" type="warning" @click="handleedit(scope.row)">{{ $t('repair.edit2') }}</el-button>
                <el-button v-permission="[91]" v-show="scope.row.stat == 2" size="mini" type="info" @click="handlecancel(scope.row)">{{ $t('repair.cancel') }}</el-button>
                <el-button v-permission="[92]" v-show="scope.row.stat == 5" size="mini" type="info" @click="handlefinish(scope.row)">{{ $t('repair.terminate') }}</el-button>
                <el-button v-permission="[6]" v-show="scope.row.stat == 1" size="mini" type="success" @click="handleDispatch(scope.row)">{{ $t('repair.Dispatch') }}</el-button>
                <el-button v-permission="[6]" v-show="scope.row.stat !== 1" size="mini" style="width: 90px;" plain disabled>{{ $t('repair.Dispatched') }}</el-button>
              </template>
            </el-table-column>
          </el-table>
        ...
        <el-tab-pane name="second">
          ...
          <el-table
            ...
            <el-table-column :label="$t('repair.phone')" align="center" prop="phoneNumber" width="120px">
              <template slot-scope="scope">
                <span>{{ scope.row.phoneNumber }}</span>
              </template>
            </el-table-column>
        ...
        <el-tab-pane :label="$t('repair.Assigned')" name="third">
          <el-table
            ...
            <el-table-column v-permission="[5, 6]" :label="$t('table.actions')" align="center" min-width="280px">
              <template slot-scope="scope">
                <el-button v-permission="[5]" type="primary" size="mini" @click="handleDetail(scope.row)">{{ $t('table2.view') }}</el-button>
                <el-button v-permission="[93]" v-show="scope.row.stat == 1" type="danger" size="mini" @click="handleDelete(scope.row)">{{ $t('Complaint.delete') }}</el-button>
                <el-button v-permission="[94]" v-show="scope.row.stat == 1" size="mini" type="warning" @click="handleedit(scope.row)">{{ $t('repair.edit2') }}</el-button>
        ...
        <el-tab-pane :label="$t('repair.TobeRepaired')" name="four">
          <el-table
            ...
            <el-table-column v-permission="[5, 6]" :label="$t('table.actions')" align="center" min-width="170px">
              <template slot-scope="scope">
                <el-button v-permission="[5]" type="primary" size="mini" @click="handleDetail(scope.row)">{{ $t('table2.view') }}</el-button>
                <el-button v-permission="[93]" v-show="scope.row.stat == 1" type="danger" size="mini" @click="handleDelete(scope.row)">{{ $t('Complaint.delete') }}</el-button>
                <el-button v-permission="[94]" v-show="scope.row.stat == 1" size="mini" type="warning" @click="handleedit(scope.row)">{{ $t('repair.edit2') }}</el-button>
...
<script>
import { repairList, repairDetail, repairtoemp, producttype, repositorylist, newservice, getserviceschedule, deleteservice, retoreposervice, serviceretoemp, endservicebackground, getremplist } from '@/api/repair'
...
export default {
  ...
  methods: {
    ...
    handleDispatch(row) {
      ...
      console.log(row)
      const regionid = this.$store.getters.regionid
      getremplist(row.expectRepositoryId).then(res => {
