  ...
  <div class="tab-container">
    ...
    <div class="app-container">
      <el-table
        ...
        <el-table-column :label="$t('lostUnits.name')" :resizable="false" prop="personName" min-width="150px" align="center">
          <template slot-scope="scope">
        ...
        <el-table-column :label="$t('lostUnits.loststat')" :resizable="false" prop="stat" min-width="110px" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.stat | zhuan }}</span>
          </template>
        </el-table-column>
        <el-table-column :label="$t('lostUnits.losttime')" :resizable="false" prop="createTime" min-width="110px" align="center">
          <template slot-scope="scope">
