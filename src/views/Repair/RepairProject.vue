  ...
  <div class="tab-container">
    ...
    <div class="app-container">
      <el-table
        ...
        style="width: 100%;">
        <el-table-column :label="$t('repair.SerialNumber')" prop="id" align="center" min-width="80">
          <template slot-scope="scope">
            <span>{{ scope.row.id }}</span>
          </template>
        </el-table-column>
        <el-table-column :label="$t('repair.itemName')" prop="name" min-width="200px" align="center">
          <template slot-scope="scope">
        ...
        <el-table-column :label="$t('repair.price2')" prop="price" min-width="80px" align="center">
          <template slot-scope="scope">
        ...
        <el-table-column v-permission="[12, 13]" :label="$t('table.actions')" align="center" min-width="200" class-name="small-padding fixed-width" fixed="right">
          <template slot-scope="scope">
