  ...
  <div class="tab-container">
    ...
    <div class="app-container">
      <el-table
       ...
       height="600"
        style="width: 100%;">
        <el-table-column :label="$t('repair.repositoryId')" prop="repositoryId" align="center" min-width="60">
          <template slot-scope="scope">
            <span>{{ scope.row.repositoryId }}</span>
          </template>
        </el-table-column>
        <el-table-column :label="$t('repair.repositoryName')" prop="repositoryName" min-width="100px" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.repositoryName }}</span>
          </template>
        </el-table-column>
        <el-table-column :label="$t('repair.submit')" align="center" prop="submit" min-width="60px">
          <template slot-scope="scope">
            <span>{{ scope.row.submit }}</span>
          </template>
        </el-table-column>
        <el-table-column :label="$t('repair.assigned')" prop="assigned" min-width="60px" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.assigned }}</span>
          </template>
        </el-table-column>
        <el-table-column :label="$t('repair.repair')" prop="repair" min-width="60px" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.repair }}</span>
          </template>
        </el-table-column>
        <el-table-column :label="$t('repair.begin')" prop="begin" min-width="60px" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.begin }}</span>
          </template>
        </el-table-column>
        <el-table-column :label="$t('repair.finished')" prop="finished" min-width="60px" align="center">
          <template slot-scope="scope">
            <span>{{ scope.row.finished }}</span>
          </template>
        </el-table-column>
        <el-table-column :label="$t('repair.comment')" prop="comment" min-width="60px" align="center">
          <template slot-scope="scope">
