      ...
      <el-card class="box-card" style="margin-top: 15px" shadow="never">
        ...
        <div class="container">
          <el-editable
            ...
            <el-editable-column :edit-render="{name: 'ElInputNumber', attrs: {min: 0.00, precision: 2}, type: 'visible'}" prop="arrivalQuantity" align="center" :label="$t('updates.dhsl')" min-width="150px"/>
