        ...
        <div class="container" style="margin-top: 25px">
          <el-form ref="personalForm" :model="personalForm" :rules="personalrules" :inline="true" status-icon class="demo-ruleForm" label-width="130px">
            <el-row>
              ...
              <!--              <el-col :span="6">-->
              <!--                <el-form-item :label="$t('StockArrival.sourceNumber')" :rules="personalForm.sourceType === '2'" prop="sourceNumber" style="margin-left: 18px;width: 100%;margin-bottom: 0;">-->
              ...
              <el-col :span="6">
                <el-form-item :label="$t('StockArrival.deptId')" style="margin-left: 18px;width: 100%;margin-bottom: 0;">
                  <el-select v-model="personalForm.deptId" size="mini" style="margin-left: 18px;width: 200px" @change="change()">
                    <el-option
              ...
              <el-col :span="6">
                <el-form-item :label="$t('StockArrival.payId')" style="margin-left: 18px;width: 100%;margin-bottom: 0;">
                  <el-select v-model="personalForm.settleMode" size="mini" style="margin-left: 18px;width: 200px" @change="change()">
                    <el-option
              ...
              <el-col :span="6">
                <el-form-item :label="$t('StockArrival.acceptDate')" prop="signDate" style="margin-left: 18px;width: 100%;margin-bottom: 0;">
                  <el-date-picker
              ...
              <el-col :span="6">
                <el-form-item :label="$t('StockArrival.arrivalDate')" prop="arrivalDate" style="margin-left: 18px;width: 100%;margin-bottom: 0;">
                  <el-date-picker
      ...
      <el-dialog :visible.sync="receiptVisible2" title="库存快照" class="normal" width="600px" center>
        <el-form class="demo-ruleForm" style="margin: 0px 6%; width: 400px">
          <el-form-item label-width="100px;" style="    width: 500px;">
            <div style="margin-left: 18px;width: 100%;margin-bottom: 0; height: 220px;overflow: hidden;background: white;" >
              <el-table
                :data="list111"
                height="220"
