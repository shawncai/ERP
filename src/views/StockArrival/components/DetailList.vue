      ...
      <el-card class="box-card" style="margin-top: 15px" shadow="never">
        ...
        <div class="container">
          <el-editable
            ...
            <el-editable-column v-if="jundgeprice()" :label="$t('updates.zk')" prop="discountRate" align="center" />
...
import { updatestockArrival2 } from '@/api/StockArrival'
  ...
  watch: {
    ...
    detaildata() {
      ...
      for (const i in this.personalForm.stockArrivalDetailVos) {
        if (this.personalForm.stockArrivalDetailVos[i].stockArrivalDetailVos) {
