      ...
      <el-card class="box-card" style="margin-top: 15px" shadow="never">
        ...
        <div class="container">
          <el-editable
            ...
            <el-editable-column prop="giveDate" align="center" :label="$t('updates.jhrq')" >
            ...
            <el-editable-column prop="hadStorageQuantity" align="center" :label="$t('updates.yrksl')" />
            <el-editable-column prop="reportCheckingQuantity" align="center" :label="$t('updates.bjsl')" />
            <el-editable-column prop="actualCheckingQuantity" align="center" :label="$t('updates.sjsl')" />
            <el-editable-column prop="qualifyQuantity" align="center" :label="$t('updates.hgsl')" />
            <el-editable-column prop="unqualifyQuantity" align="center" :label="$t('updates.bhgsl')" />
