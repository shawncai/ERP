      ...
      <el-card class="box-card" style="margin-top: 15px">
        ...
        <div class="container">
          <el-editable
            ...
            <el-editable-column prop="productCode" align="center" :label="$t('updates.zj')" min-width="150px"/>
            <el-editable-column prop="productName" align="center" :label="$t('updates.zjmc')" min-width="150px"/>
            ...
            <el-editable-column :edit-render="{name: 'ElInputNumber', attrs: {min: 0.0, max: 1.0}, type: 'visible'}" prop="lossRate" align="center" :label="$t('updates.shl')" min-width="150px"/>
