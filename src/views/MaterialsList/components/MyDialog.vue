<template>
  <el-dialog :visible.sync="editVisible" :editcontrol="editcontrol" :editdata="editdata" :close-on-press-escape="false" class="edit" width="1010px" top="-10px" :title="$t('updates.xgwlqd')" @close="$emit('update:editcontrol', false)">
    <!--基本信息-->
    ...
    <el-card class="box-card" style="margin-top: 15px">
      ...
      <div class="container">
        <el-editable
          ...
          <el-editable-column :edit-render="{name: 'ElInputNumber', attrs: {min: 0}, type: 'visible'}" prop="quantity" align="center" :label="$t('updates.de')" min-width="150px"/>
          <el-editable-column :edit-render="{name: 'ElInputNumber', attrs: {min: 0}, type: 'visible'}" prop="lossRate" align="center" :label="$t('updates.shl')" min-width="150px"/>
          <el-editable-column :edit-render="{name: 'ElSelect', options: isKeyList, type: 'visible'}" prop="isKey" align="center" :label="$t('updates.sfgjj')" min-width="150px"/>
        </el-editable>
      </div>
    </el-card>
