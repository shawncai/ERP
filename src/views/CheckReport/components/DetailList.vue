    ...
    <el-card class="box-card" style="margin-top: 15px" shadow="never">
      ...
      <div class="container">
        <el-editable
          ...
          <el-editable-column prop="checkItemName" fixed align="center" :label="$t('updates.jyxm')" min-width="150px"/>
          <el-editable-column prop="checkContent" fixed align="center" :label="$t('updates.jynr')" min-width="150px"/>
          <el-editable-column prop="checkTools" fixed align="center" :label="$t('updates.jygj')" min-width="150px"/>
          <el-editable-column prop="checkQuantity" align="center" :label="$t('updates.ybs')" min-width="150px"/>
          ...
          <el-editable-column prop="checkResult" align="center" :label="$t('updates.jyjg')" min-width="150px">
            <template slot-scope="scope">
              <p>{{ scope.row.chectResult | chectResultFilter }}</p>
            </template>
          </el-editable-column>
          <el-editable-column prop="remarks" align="center" :label="$t('updates.dxjl')" min-width="150px"/>
        </el-editable>
      </div>
    </el-card>
    <!--审核状态-->
