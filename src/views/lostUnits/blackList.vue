  ...
  <div class="tab-container">
    ...
    <div class="app-container">
      <el-table
        ...
        style="width: 100%;">
        <el-table-column :label="$t('lostUnits.Serialnumber')" prop="id" align="center" min-width="80">
          <template slot-scope="scope">
            <span>{{ scope.row.id }}</span>
          </template>
        </el-table-column>
        <el-table-column :label="$t('lostUnits.name')" prop="personName" min-width="130px" align="center">
          <template slot-scope="scope">
        ...
        <el-table-column :label="$t('lostUnits.stat')" prop="stat" min-width="90px" align="center">
          <template slot-scope="scope">
        ...
        <el-table-column v-permission="[42]" :label="$t('table.actions')" align="center" min-width="100" >
          <template slot-scope="scope">
