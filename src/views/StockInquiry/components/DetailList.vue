<template>
  <el-dialog :visible.sync="editVisible" :detailcontrol="detailcontrol" :detaildata="detaildata" :close-on-press-escape="false" :title="personalForm.inquiryNumber +$t('updates.xqing')" append-to-body width="1010px" class="edit" top="-10px" @close="$emit('update:detailcontrol', false)">
    <div id="printTest" >
      <!--基本信息-->
      <el-card class="box-card" style="margin-top: 63px" shadow="never">
        ...
        <div class="container" style="margin-top: 37px">
          <el-form :model="personalForm" :inline="true" status-icon class="demo-ruleForm" label-width="130px">
            <el-row>
              <el-col :span="12">
                <el-form-item class="print2" label="采购询价单编号" style="width: 100%;display: none">
                  {{ personalForm.inquiryNumber }}
                </el-form-item>
              </el-col>
              <el-col :span="12">
      ...
      <el-card class="box-card" style="margin-top: 15px" shadow="never">
        ...
        <div class="container">
          <el-editable
            ...
            <el-editable-column :label="$t('updates.jhsl')" prop="plannedQuantity" align="center" />
            <el-editable-column :label="$t('updates.jhrq')" prop="planDeliveryDate" align="center" />
            ...
            <el-editable-column :label="$t('updates.bz')" prop="applicationReason" align="center" />
...
import { updatestockInquiry2 } from '@/api/StockInquiry'
          ...
          header: `<div class="pringtitle">
                    <div class="custom-p"> 江苏嗯哇科技有限公司 </div>
                      ...
                      <div class="ordername">采购询价订单</div>
                        ...
                        <div class="itemcontent">${this.personalForm.inquiryDate}</div>
                          </div>
                        <div class="item">
                         <div class="itemname">编号：</div>
                        <div class="itemcontent">${this.personalForm.inquiryNumber}</div>
                          </div>
                          </div>
                        </div>`,
          bottom: `<div>
