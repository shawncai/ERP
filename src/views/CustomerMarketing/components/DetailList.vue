<template>
  <el-dialog :visible.sync="editVisible" :detailcontrol="detailcontrol" :detaildata="detaildata" :close-on-press-escape="false" :title="personalForm.chatNumber +$t('updates.xqing')" append-to-body width="1010px" class="edit" top="-10px" @close="$emit('update:detailcontrol', false)">
    <!--基本信息-->
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item :label="$t('CustomerMarketing.phase')" style="width: 100%;">
                <span>{{ personalForm.phase | phaseFilter }}</span>
              </el-form-item>
            </el-col>
            <el-col :span="12">
