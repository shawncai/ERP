<template>
  <div class="ERP-container">
    <el-card class="box-card" style="margin-top: 10px" shadow="never">
      ...
      <el-input v-model="getemplist.count" :placeholder="$t('updates.fqqs')" clearable class="filter-item" @keyup.enter.native="handleFilter"/>

      <el-select v-model="getemplist.stat" :value="getemplist.stat" :placeholder="$t('updates.stat')" class="filter-item" clearable @keyup.enter.native="handleFilter">
