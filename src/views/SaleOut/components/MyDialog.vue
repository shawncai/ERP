<template>
  <el-dialog :visible.sync="editVisible" :editcontrol="editcontrol" :editdata="editdata" :close-on-press-escape="false" :title="personalForm.number +$t('updates.xg') + '123'" width="1010px" class="edit" top="-10px" @close="$emit('update:editcontrol', false)">
    <!--基本信息-->
    ...
    <el-card class="box-card" style="margin-top: 15px" shadow="never">
      ...
      <div class="container">
        <el-editable
          ...
          <el-editable-column :label="$t('Hmodule.hw')" prop="location" align="center" fixed="left" min-width="150">
            <template slot-scope="scope">
              <p>{{ getLocationData(scope.row) }}</p>
            </template>
          </el-editable-column>
          <el-editable-column :edit-render="{name: 'ElInput', type: 'visible'}" :label="$t('Hmodule.pc')" fixed="left" prop="batch" align="center" min-width="150" >
  ...
  methods: {
    ...
    getReceivableMoney() {
      ...
      if ((this.personalForm.sourceType === '1' || this.personalForm.sourceType === '3' || this.personalForm.sourceType === '4' || this.personalForm.sourceType === '5' || this.personalForm.sourceType === '6') && this.personalForm.useMonth === null) {
        ...
        console.log('789', 789)
        let needmoney = Number(this.personalForm.shouldMoney)
        const needmoney2 = Number(this.personalForm.shouldMoney) + Number(this.personalForm.couponMoney)
        if (needmoney < 0) {
          needmoney = 0
        }
