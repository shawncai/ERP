      ...
      <el-card class="box-card" style="margin-top: 15px" shadow="never">
        ...
        <div class="container">
          <el-editable
            ...
            <el-editable-column prop="quantity" align="center" :label="$t('updates.cksli')" />
            ...
            <el-editable-column prop="taxprice" align="center" :label="$t('updates.ckj')" />
            ...
            <el-editable-column prop="includeTaxCostMoney" align="center" :label="$t('updates.ckje')" />
