<template>
  <div class="ERP-container">
    <el-card class="box-card" style="margin-top: 10px" shadow="never">
      ...
      <el-input v-model="getemplist.costCode" :placeholder="$t('updates.fydm')" class="filter-item" clearable @keyup.enter.native="handleFilter"/>

      <el-input v-model="getemplist.costCategory" :placeholder="$t('updates.fylb')" class="filter-item" clearable @keyup.enter.native="handleFilter"/>
