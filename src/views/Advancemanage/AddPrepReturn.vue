      ...
      <el-card class="box-card" style="margin-top: 15px" shadow="never">
        ...
        <div class="container">
          <el-editable
            ...
            <el-editable-column prop="quantity" align="center" :label="$t('updates.shuli')" min-width="170px"/>
            ...
            <el-editable-column prop="discount" align="center" :label="$t('updates.zko')" min-width="170px"/>
