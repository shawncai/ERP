  ...
  <div class="ERP-container">
    ...
    <el-card :body-style="	{ padding: '10px' }" class="box-card" shadow="never">
      ...
      <el-table
        ...
        <el-table-column :label="$t('Advancemanage.advanceMoney')" :resizable="false" prop="advanceMoney" align="center" min-width="150">
          <template slot-scope="scope">
...
<script>
import { advanceorderlist, deleteadvanceorder, updateadvanceorder2, advanceorderGetList } from '@/api/Advancemanage'
...
export default {
  ...
  methods: {
    ...
    getlist() {
      ...
      advanceorderGetList(this.getemplist).then(res => {
        if (res.data.ret === 200) {
