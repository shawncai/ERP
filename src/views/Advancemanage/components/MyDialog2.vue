    ...
    <el-card class="box-card" style="margin-top: 15px" shadow="never">
      ...
      <div class="container">
        <el-editable
          ...
          <el-editable-column prop="productCategory" align="center" :label="$t('updates.spfl')" min-width="150px"/>
          <el-editable-column prop="productCode" align="center" :label="$t('updates.spbh')" min-width="150px"/>
          <el-editable-column prop="productName" align="center" :label="$t('updates.spmc')" min-width="150px"/>
          <el-editable-column prop="unit" align="center" :label="$t('updates.jbdw')" min-width="150px"/>
          <el-editable-column :label="$t('Hmodule.gg')" prop="productType" align="center" min-width="150px"/>
          <el-editable-column prop="unit" align="center" :label="$t('updates.ggxh')" min-width="150px"/>
          ...
          <el-editable-column :edit-render="{name: 'ElInputNumber', attrs: {min: 0}, type: 'visible'}" prop="quantity" align="center" :label="$t('updates.yssl')" min-width="170px"/>
          <el-editable-column prop="salePrice" align="center" :label="$t('updates.lsj')" min-width="170px"/>
          <el-editable-column prop="costPrice" align="center" :label="$t('updates.cbj')" min-width="170px"/>
          <el-editable-column prop="includeTaxMoney" align="center" :label="$t('updates.hsje')" min-width="170px"/>
          <el-editable-column prop="taxRate" align="center" :label="$t('updates.slv')" min-width="170px"/>
          ...
          <el-editable-column prop="discount" align="center" :label="$t('updates.cklv')" min-width="170px"/>
