<template>
  <el-dialog :visible.sync="employeeVisible" :createcontrol="createcontrol" :close-on-press-escape="false" :title="$t('Hmodule.xzyg')" top="10px" append-to-body @close="$emit('update:createcontrol', false)">
...
export default {
  ...
  data() {
    return {
      ...
      repositories: [],
      // 员工选择框控制
      employeeVisible: this.createcontrol,
      // 小区经理选择框控制
