  ...
  <el-dialog :visible.sync="editVisible" :detailcontrol="detailcontrol" :detaildata="detaildata" :close-on-press-escape="false" :title="personalForm.accessNumber +$t('updates.xqing')" append-to-body width="1010px" class="edit" top="-10px" @close="$emit('update:detailcontrol', false)">
    <div id="printTest" >
      ...
      <el-card class="box-card" style="margin-top: 63px" shadow="never">
        ...
        <button v-if="personalForm.judgeStat !== 0 || personalForm.judgeStat !== 3" class="print" style="font-size: 13px;background: white;" @click="printdata">{{ $t('Hmodule.dy') }}</button>
        <div class="container" style="margin-top: 37px">
          <el-form :model="personalForm" :inline="true" status-icon class="demo-ruleForm" label-width="130px">
            <el-row>
              <el-col :span="12">
                <el-form-item :label="$t('Hmodule.lldbh')" class="print2" style="width: 100%;display: none">
      ...
      <el-card class="box-card" style="margin-top: 15px" shadow="never">
        <h2 ref="fuzhu" class="form-name" style="font-size: 16px;color: #606266;margin-top: -5px;">{{ $t('Hmodule.zscjh') }}</h2>
        <div class="container">
          <el-editable
            ref="editable"
            :data.sync="list2"
            ...
            <el-editable-column :label="$t('Hmodule.ggzx')" prop="workCenterId" align="center" />
            <el-editable-column :label="$t('Hmodule.xqsl')" prop="requireQuantity" align="center" />
            <el-editable-column :label="$t('Hmodule.llsl')" prop="accessQuantity" align="center" />
            <el-editable-column :label="$t('Hmodule.ytlsl')" prop="retreatQuantity" align="center" />
    ...
    printdata() {
      ...
      printJS({
        ...
        properties: [
          ...
          { field: 'accessQuantity', displayName: '领料数量', columnSize: `100px` },
          { field: 'retreatQuantity', displayName: '已退料数量', columnSize: `100px` }
        ],
        header: `<div class="pringtitle">
                    <div class="custom-p"> 江苏嗯哇科技有限公司 </div>
                      <br>
                      <div class="ordername">领料订单</div>
                        <br>
                        <div class="line1"></div>
                        <div class="line2"></div>
                        <div class="supplier">
                        <div class="item">
                        <div class="itemname">领料仓库：</div>
                        <div class="itemcontent">${this.personalForm.accessRepositoryName}</div>
                        </div>
                        <div class="item">
                         <div class="itemname">日期：</div>
                        <div class="itemcontent">${this.personalForm.provideDate || ''}</div>
                          </div>
                        <div class="item">
                         <div class="itemname">编号：</div>
                        <div class="itemcontent">${this.personalForm.accessNumber}</div>
                          </div>
                          </div>
                        </div>`,
        bottom: `<div>
                  <div class="printbottom" style="display: flex;align-items: center;justify-content: center;width: 100%;margin-top: 20px">
                    ...
                    <div class="bottomitem" style="width: 25%;display: flex;align-items: center;justify-content: center;flex-wrap: nowrap">
                        <div class="ceshi">领料人：</div>
                        <div class="bottomname">${this.personalForm.accessPersonName}</div>
                    </div>
                    <div class="bottomitem" style="width: 25%;display: flex;align-items: center;justify-content: center;flex-wrap: nowrap">
