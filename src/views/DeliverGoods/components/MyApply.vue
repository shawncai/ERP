      ...
      <el-row>
        <el-form ref="getemplist" :model="getemplist" style="margin-top: -9px">
          ...
          <el-col :span="3" style="margin-left: 20px">
            <el-form-item>
              <el-input v-model="applyPersonId" :placeholder="$t('StockApply.applyPersonId')" class="filter-item" clearable @keyup.enter.native="handleFilter" @focus="handlechooseStock" @clear="restFilter"/>
            </el-form-item>
