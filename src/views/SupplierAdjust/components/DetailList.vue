      ...
      <el-card class="box-card" style="margin-top: 15px" shadow="never">
        ...
        <div>
          <el-button
            v-show="
              isReview() &&
                (personalForm.receiptStat === 1 ||
                personalForm.receiptStat === 2 ||
                personalForm.receiptStat === 3)
            "
...
export default {
  ...
  methods: {
    ...
    isReview() {
      if (
        this.personalForm.approvalUseVos !== '' &&
        this.personalForm.approvalUseVos !== null &&
        this.personalForm.approvalUseVos !== undefined &&
        this.personalForm.approvalUseVos.length !== 0
      ) {
