      ...
      <el-card class="box-card" style="margin-top: 15px">
        ...
        <div class="container">
          <el-editable
            ...
            <el-editable-column :edit-render="{name: 'ElInputNumber', type: 'visible', attrs: {min: 0}}" prop="newSalePrice" align="center" :label="$t('updates.lstzj')" width="150px">
            ...
            <el-editable-column :edit-render="{name: 'ElInputNumber', type: 'visible', attrs: {min: 0}}" prop="newTradePrice" align="center" :label="$t('updates.pftzj')" width="150px">
              <template slot="edit" slot-scope="scope">
                <el-input-number
                  :precision="2"
                  :controls="false"
            ...
            <el-editable-column :edit-render="{name: 'ElInputNumber', type: 'visible', attrs: {min: 0}}" prop="newMemberPrice" align="center" :label="$t('updates.yytzj')" width="150px">
              <template slot="edit" slot-scope="scope">
                <el-input-number
                  :precision="2"
                  :controls="false"
