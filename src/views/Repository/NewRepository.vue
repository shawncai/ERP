      ...
      <el-card :body-style="	{ padding: '5px' }" class="box-card" shadow="never">
        ...
        <div class="container" style="margin-top: 25px">
          <el-form ref="RepositoryForm" :model="RepositoryForm" :rules="Repositoryrules" :inline="true" size="mini" status-icon class="demo-ruleForm" label-position="left" label-width="130px">
            <el-row>
              <el-col :span="6">
                <el-form-item :label="$t('Repository.repositoryName')" prop="repositoryName" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-input v-model="RepositoryForm.repositoryName" clearable style="width: 200px"/>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item :label="$t('Repository.type')" prop="type" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-select ref="clear" v-model="RepositoryForm.type" :value="RepositoryForm.type" style="width: 200px" @change="updateType2" @focus="updateType">
              ...
              <el-col :span="6">
                <el-form-item :label="$t('Repository.longitude')" :rules="RepositoryForm.type !== 2 ? Repositoryrules.longitude:[{ required: true, message: '请输入经度', trigger: 'change' }]" prop="longitude" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-input v-model="RepositoryForm.longitude" autocomplete="new-password" clearable style="width: 200px"/>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item :label="$t('Repository.latitude')" :rules="RepositoryForm.type !== 2 ? Repositoryrules.longitude:[{ required: true, message: '请输入纬度', trigger: 'change' }]" prop="latitude" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-input v-model="RepositoryForm.latitude" clearable style="width: 200px"/>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item :label="$t('public.phone')" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-input v-model="RepositoryForm.phone" clearable style="width: 200px"/>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item :label="$t('public.address')" prop="address" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-input v-model="RepositoryForm.address" clearable style="width: 200px"/>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item :label="$t('Repository.regionId')" prop="regionId" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-cascader
                    :options="regions"
                    :props="props"
                    v-model="regionId"
              ...
              <el-col :span="6" style="height: 57px">
                <el-form-item :label="$t('Repository.stat')" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-radio-group v-model="RepositoryForm.stat" style="width: 200px">
              ...
              <el-col :span="6">
                <el-form-item :label="$t('updates.lx')" prop="categoryId" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-select ref="clear2" v-model="RepositoryForm.categoryId" :placeholder="$t('updates.qxz')" style="width: 200px" @focus="updateType2">
                    <el-option v-show="false" label="" value=""/>
                    <el-option
              ...
              <el-col :span="6">
                <el-form-item :label="$t('Repository.managerPeople')" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-input v-model="managerPeople" :value="managerPeople" :placeholder="$t('updates.qxz')" clearable style="width: 200px" @focus="handlechoose"/>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <!--弹出员工列表开始-->
              ...
              <el-col :span="6">
                <!--弹窗员工列表结束-->
                <el-form-item :label="$t('Repository.createTime')" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-date-picker
              ...
              <el-col :span="6">
                <el-form-item :label="$t('Repository.regionManager')" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-input v-model="regionManagerId" :value="regionManagerId" :placeholder="$t('updates.qxz')" style="width: 200px" clearable @focus="handlechoose2"/>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <!--弹出员工列表开始-->
                ...
                <!--小区经理选择弹窗结束-->
                <!--弹窗员工列表结束-->
                <!-- <el-form-item :label="$t('Repository.attributes')" prop="attributes" style="margin-left: 18px;width: 100%;margin-bottom: 0">
            <el-select v-model="RepositoryForm.attributes" :value="RepositoryForm.attributes" :placeholder="$t('updates.qxz')" clearable style="width: 200px">
              ...
              <el-col :span="6">
                <el-form-item :label="$t('Repository.countryId')" prop="countryId" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-select v-model="RepositoryForm.countryId" placeholder="请选择国家" style="width: 200px" @change ="handlechange">
                    <el-option
              ...
              <el-col :span="6">
                <el-form-item :label="$t('Repository.description')" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-input v-model="RepositoryForm.description" style="width: 200px" clearable/>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
