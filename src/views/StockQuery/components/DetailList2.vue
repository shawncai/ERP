      ...
      <div class="container" style="margin-top: 37px">
        <el-form :model="personalForm" :inline="true" status-icon class="demo-ruleForm" label-width="130px">
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item :label="$t('StockQuery.arrivalQuantity')" style="width: 100%;">
                {{ personalForm.arrivalQuantity }}
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="$t('StockQuery.arrivalIncludedTax')" prop="applyDeptId" style="width: 100%;">
                {{ personalForm.arrivalIncludedTax }}
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="$t('StockQuery.arrivalUnIncludedTax')" prop="sourceType" style="width: 100%;">
                {{ personalForm.arrivalUnIncludedTax }}
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="$t('StockQuery.returnQuantity')" prop="applyDate" style="width: 100%;">
                {{ personalForm.returnQuantity }}
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="$t('StockQuery.returnIncludedTax')" prop="applyDate" style="width: 100%;">
                {{ personalForm.returnIncludedTax }}
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="$t('StockQuery.returnUnIncludedTax')" prop="applyDate" style="width: 100%;">
                {{ personalForm.returnUnIncludedTax }}
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
