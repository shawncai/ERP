<template>
  <el-dialog :visible.sync="editVisible" :detailcontrol="detailcontrol" :detaildata="detaildata" :close-on-press-escape="false" :title="personalForm.voucherNo +$t('updates.xqing')" append-to-body width="1010px" class="edit" top="-10px" @close="$emit('update:detailcontrol', false)">
    <div id="printTest" >
      <!--基本信息-->
        ...
        <div class="container" style="margin-top: 37px">
          <el-form :model="personalForm" :inline="true" status-icon class="demo-ruleForm" label-width="130px">
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item :label="$t('Voucher.rq')" prop="VoucherDate" style="width: 100%;">
                  <span>{{ personalForm.receiptDate }}</span>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item :label="$t('Voucher.zdr')" prop="handlePersonId" style="width: 100%;">
                  <span>{{ personalForm.createPersonName }}</span>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item :label="$t('Voucher.hjjfje')" style="width: 100%;">
                  <span>{{ personalForm.totalDebitMoney }}</span>
                </el-form-item>
              </el-col>
              <el-col :span="12">
