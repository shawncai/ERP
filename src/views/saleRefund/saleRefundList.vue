...
import { saleRefundList, deleteSaleRefund, judgeSaleRefund, saleRefundListGetList } from '@/api/SaleOrder'
...
export default {
  ...
  methods: {
    ...
    getlist() {
      ...
      saleRefundListGetList(this.getemplist).then(res => {
        if (res.data.ret === 200) {
