    ...
    <el-card :body-style="	{ padding: '10px' }" class="box-card" shadow="never">
      ...
      <el-table
        ...
        <el-table-column
          ...
          fixed="left"
          align="center"/>
        <el-table-column :label="$t('public.id')" :resizable="false" sortable prop="payNumber" fixed="left" align="center" min-width="150">
        ...
        <el-table-column :label="$t('AdvancePay.totalMoney')" :resizable="false" prop="totalMoney" align="center" min-width="150">
          <template slot-scope="scope">
...
<script>
import { paylist, updateadvancepay2, deleteadvancepay, payGetList } from '@/api/AdvancePay'
...
export default {
  ...
  methods: {
    ...
    getlist() {
      ...
      payGetList(this.getemplist).then(res => {
        if (res.data.ret === 200) {
