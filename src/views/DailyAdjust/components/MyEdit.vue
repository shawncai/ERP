<template>
  <el-dialog :visible.sync="editVisible" :editcontrol="editcontrol" :editdata="editdata" :close-on-press-escape="false" class="edit" width="1010px" top="-10px" :title="$t('updates.xgtzd')" @close="$emit('update:editcontrol', false)">
    <!--基本信息-->
    ...
    <el-card class="box-card" style="margin-top: 15px">
      ...
      <div class="container">
        <el-editable
          ...
          <el-editable-column :edit-render="{type: 'default'}" prop="adjustType" align="center" :label="$t('updates.tzlx')" width="200px">
            <template slot-scope="scope">
          ...
          <el-editable-column :edit-render="{name: 'ElInputNumber', type: 'visible'}" prop="adjustQuantity" align="center" :label="$t('updates.tzsl')" width="150px"/>
