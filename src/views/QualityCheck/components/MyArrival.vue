      ...
      <el-row>
        <el-form ref="getemplist" :model="getemplist" style="margin-top: -9px">
          ...
          <el-col :span="3" style="margin-left: 20px">
            <el-form-item>
              <el-input v-model="stockPersonId" :placeholder="$t('StockArrival.stockPersonId')" clearable @clear="restFilter2" @keyup.enter.native="handleFilter" @focus="handlechooseStock"/>
            </el-form-item>
    ...
    async handleConfirm() {
      ...
      const arrivalDetail = arrivaldata.map(function(item) {
        return {
          ...
          unit: item.unit,
          basicQuantity: item.arrivalQuantity,
          checkQuantity: item.arrivalQuantity,
          checkedQuantity: 0,
          arrivalQuantity: item.arrivalQuantity,
          sourceNumber: number,
          sourceSerialNumber: item.id,
          hadCheckQuantity: item.reportCheckingQuantity
        }
      })
