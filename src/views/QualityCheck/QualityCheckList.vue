        ...
        <el-form ref="getemplist" :model="getemplist" label-width="100px" style="margin-top: -9px">
          ...
          <el-col :span="5" style="margin-left: 10px">
            <el-form-item label="报检员">
              <el-input v-model="reportPersonId" :placeholder="$t('QualityCheck.reportPersonId')" clearable @keyup.enter.native="handleFilter" @focus="handlechooseStock"/>
            </el-form-item>
    ...
    <el-card class="box-card" style="margin-top: 10px" shadow="never">
      ...
      <el-table
        ...
        <el-table-column :label="$t('public.actions')" :resizable="false" align="center" min-width="230">
          <template slot-scope="scope">
            <el-button v-permission2="['227-229-3', scope.row.createPersonId]" v-if="scope.row.judgeStat === 0" title="修改" type="primary" size="mini" icon="el-icon-edit" circle @click="handleEdit(scope.row)"/>
            ...
            <el-button v-permission2="['227-229-2', scope.row.createPersonId]" v-if="scope.row.judgeStat === 0" title="删除" size="mini" type="danger" icon="el-icon-delete" circle @click="handleDelete(scope.row)"/>
          </template>
        </el-table-column>
      </el-table>
      <!-- 列表结束 -->
