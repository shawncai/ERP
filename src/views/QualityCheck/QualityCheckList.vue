<template>
  <div class="ERP-container">
    <el-card class="box-card" style="margin-top: 10px;" shadow="never">
      ...
      <el-input v-model="getemplist.title" :placeholder="$t('QualityCheck.title')" class="filter-item" clearable @keyup.enter.native="handleFilter"/>

      <el-input v-model="getemplist.checkNumber" :placeholder="$t('updates.zjbh')" class="filter-item" clearable @keyup.enter.native="handleFilter"/>

      <el-input v-model="reportPersonId" :placeholder="$t('QualityCheck.reportPersonId')" class="filter-item" clearable @clear="restFilter2" @keyup.enter.native="handleFilter" @focus="handlechooseStock"/>
    ...
    <el-card class="box-card" style="margin-top: 10px" shadow="never">
      ...
      <!-- 打印操作 -->
      <el-button v-permission="['227-229-7']" v-waves class="filter-item" icon="el-icon-printer" style="width: 86px" @click="handlePrint">{{ $t('public.print') }}</el-button>
      <!-- 新建操作 -->
      <el-button v-permission="['227-229-1']" v-waves class="filter-item" icon="el-icon-plus" type="success" style="width: 86px" @click="handleAdd">{{ $t('public.add') }}</el-button>
    </el-card>
