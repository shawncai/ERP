  ...
  <div class="ERP-container">
    <div class="app-container" style="padding-right: 0">
      ...
      <el-card :body-style="	{ padding: '5px' }" class="box-card" shadow="never">
        ...
        <div class="container" style="margin-top: 25px">
          <el-form ref="personalForm" :model="personalForm" :rules="personalrules" :inline="true" size="mini" status-icon class="demo-ruleForm" label-position="left" label-width="130px">
            <el-row>
              <el-col :span="6">
                <el-form-item :label="$t('WarehouseAdjust.title2')" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-input v-model="personalForm.title" style="width: 200px" clearable/>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item :label="$t('WarehouseAdjust.handlePersonId')" prop="handlePersonId" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-input v-model="handlePersonId" style="width: 200px" clearable @focus="handlechoose"/>
                </el-form-item>
                <my-create :createcontrol.sync="createcontrol" @createname="createname"/>
              </el-col>
              <el-col :span="6">
                <el-form-item :label="$t('WarehouseAdjust.adjustDeptId')" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-select v-model="personalForm.adjustDeptId" style="width: 200px" clearable >
                    <el-option
              ...
              <el-col :span="6">
                <el-form-item :label="$t('WarehouseAdjust.adjustRepositoryId')" prop="adjustRepositoryId" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-input v-model="adjustRepositoryId" style="width: 200px" clearable @focus="handlechooseRep"/>
                </el-form-item>
              </el-col>
            ...
            <el-row style="margin-top: 23px">
              <el-col :span="6">
                <el-form-item :label="$t('WarehouseAdjust.adjustReason')" style="margin-left: 18px;width: 100%;margin-bottom: 0">
                  <el-input v-model="personalForm.adjustReason" style="width: 200px" clearable/>
                </el-form-item>
              </el-col>
              <el-col :span="6">
      ...
      <el-card :body-style="	{ padding: '5px' }" class="box-card" shadow="never" style="margin-top: 5px;margin-bottom: 20px">
        ...
        <div ref="fuzhu" class="form-name">{{ $t('updates.kwtzdmx') }}</div>
        ...
        <div class="container">
          <el-editable
            ...
            <el-editable-column :label="$t('updates.drkw')" prop="enterLocationId" align="center" width="150px">
              <template slot-scope="scope">
                <el-select v-model="scope.row.enterLocationId" :value="scope.row.enterLocationId" :placeholder="$t('Hmodule.xzhw')" filterable clearable style="margin-left: 18px;width: 100%;margin-bottom: 0" @visible-change="alllocations($event,scope)">
                  <el-option
