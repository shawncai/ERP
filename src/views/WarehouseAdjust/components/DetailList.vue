<template>
  <el-dialog :visible.sync="editVisible" :detailcontrol="detailcontrol" :editdata="detaildata" :close-on-press-escape="false" append-to-body class="edit" top="10px" title="修改期初库存单" @close="$emit('update:detailcontrol', false)">
    <div id="printTest" >
      <!--基本信息-->
